...
namespace Nop.Services.Authentication
{
    ...
    public class AuthenticationMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            // todo cheking wheter CheckIfAuthenticationStateIsValidAsync() is true using by HttpClient and Middleware implementation
            // we need to require the server via http request and get the response directly from Middleware.
