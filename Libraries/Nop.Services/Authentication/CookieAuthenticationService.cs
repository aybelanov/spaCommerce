...
{
    // changed added IGenericAttributeService
    /// <summary>
    ...
    public partial class CookieAuthenticationService : IAuthenticationService
    {
        ...
        public virtual async Task SignIn(Customer customer, bool isPersistent)
        {
            ...
            _genericAttributeService.SaveAttribute<bool?>(customer, NopCustomerDefaults.AuthenticationStateAttribute, true);
        ...
        public virtual async Task SignOut()
        {
            ...
            var customer = _cachedCustomer;
            _cachedCustomer = null;

            //changed await is deleted
            await _httpContextAccessor.HttpContext.SignOutAsync(NopAuthenticationDefaults.AuthenticationScheme);

            _genericAttributeService.SaveAttribute<bool?>(customer, NopCustomerDefaults.AuthenticationStateAttribute, false);
        ...
        public virtual Customer GetAuthenticatedCustomer()
        {
            ...
            {
                _genericAttributeService.SaveAttribute<bool?>(_cachedCustomer, NopCustomerDefaults.AuthenticationStateAttribute, true);
