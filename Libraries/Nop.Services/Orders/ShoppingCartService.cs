...
{
    // todo urlHelper to linkGenerator
    //  changed urlHelper to linkGenerator
    /// <summary>
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
            ...
            int storeId, int quantity, bool addRequiredProducts, int shoppingCartItemId)
        {
            ...
            foreach (var requiredProduct in requiredProducts)
            {
                ...
                var productUrl = _linkGenerator.GetPathByRouteValues(nameof(Product), new { SeName = _urlRecordService.GetSeName(requiredProduct) });
                var requiredProductWarning = _catalogSettings.UseLinksInRequiredProductWarnings
                    ...
                    ? string.Format(warningLocale, $"<a href=\"{_linkGenerator.GetPathByRouteValues(nameof(Product), new { SeName = _urlRecordService.GetSeName(requiredProduct) })}\">{requiredProductName}</a>", requiredProductRequiredQuantity)
