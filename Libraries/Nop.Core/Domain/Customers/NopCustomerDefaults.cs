...
namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        //added CustomerAuthenticationStateAttribute
        /// <summary>
        /// Gets a name of generic attribute to store the value of 'CustomerAuthenticationState'
        /// </summary>
        public static string AuthenticationStateAttribute => "CustomerAuthenticationState";
        #endregion
    }
}