...
namespace spaCommerce.Extensions
{
    public static class HtmlExtensions
    {
        ...
        // ADDED for NopBlazorComponent.cs
        /// <summary>
        /// Get topic SEO name
        /// </summary>
        /// <typeparam name="T">T</typeparam>
        ...
        //added
        public static IEnumerable<Type> GetResourcesFromPlugin(this IHtmlHelper html)
        {
            var typeFinder = EngineContext.Current.Resolve<ITypeFinder>();
            var resourceComponents = typeFinder.FindClassesOfType<IHtmlResources>(true);
        ...
        // added
        /// <summary>
        /// It's an analog for <see cref="HtmlHelperComponentPrerenderingExtensions.RenderComponentAsync{TComponent}(IHtmlHelper, RenderMode)"/>
        /// Type is an argument of the method here.
        /// </summary>
        /// <param name="html"></param>
        /// <param name="type"></param>
        /// <param name="vs"></param>
        /// <returns></returns>
        public static Task<IHtmlContent> RenderComponentAsync(this IHtmlHelper html, Type type, RenderMode renderMode)
        {
            MethodInfo method = typeof(HtmlHelperComponentExtensions).GetMethod("RenderComponentAsync", new[] { typeof(IHtmlHelper), typeof(RenderMode) });
            var generic = method.MakeGenericMethod(type);
            return generic.Invoke(null, new object[] { html, renderMode }) as Task<IHtmlContent>;
        }

        // added
        /// <summary>
        /// It's an analog for <see cref="HtmlHelperComponentPrerenderingExtensions.RenderComponentAsync{TComponent}(IHtmlHelper, RenderMode, object)"/>
        /// Here Type is an argument of the method
        /// </summary>
        /// <param name="html"></param>
        /// <param name="type"></param>
        /// <param name="vs"></param>
        /// <returns></returns>
        public static Task<IHtmlContent> RenderComponentAsync(this IHtmlHelper html, Type type, RenderMode renderMode, params object[] vs)
        {
            MethodInfo method = typeof(HtmlHelperComponentExtensions).GetMethod("RenderComponentAsync", new[] { typeof(IHtmlHelper), typeof(RenderMode), typeof(object) });
            var generic = method.MakeGenericMethod(type);
            return generic.Invoke(null, new object[] { html, renderMode, vs }) as Task<IHtmlContent>;
        }
