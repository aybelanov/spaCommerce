...
namespace spaCommerce.Infrastructure
{
    public class ServiceRegistar : IServiceRegistrar
    {
        public void Register(IServiceCollection services, IConfiguration configuration, ITypeFinder typeFinder, NopConfig nopConfig)
        {
            ...
            //services.AddScoped<, WeatherForecastService>().SingleInstance();
            services.AddScoped<INewsletterComponentService, NewsletterComponentService>();
            services.AddScoped<IShoppingCartComponentService, ShoppingCartComponentService>();
