...
using spaCommerce.Areas.Admin.Factories;
using Nop.Web.Framework.Factories;
using spaCommerce.Infrastructure.Installation;
using spaCommerce.Services;
using Microsoft.JSInterop;
using Microsoft.AspNetCore.Http;
using Nop.Services.Catalog;

namespace spaCommerce.Infrastructure
{
    // CHANGED WeatherForecastService
    /// <summary>
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        {
            // ADDED spa dependencies
            //builder.RegisterType<WeatherForecastService>().SingleInstance();
            builder.RegisterType<NewsletterComponentService>().As<INewsletterComponentService>().InstancePerLifetimeScope();
            builder.RegisterType<ShoppingCartComponentService>().As<IShoppingCartComponentService>().InstancePerLifetimeScope();
