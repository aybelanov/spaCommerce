...
namespace spaCommerce.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        // changed acces value
        public virtual string ParseCustomCustomerAttributes(IFormCollection form)
        {
            if (form == null)
        ...
        public virtual IActionResult UploadAvatar()
        {
            ...
            if (Request.Form.Files[0] == null)
                return new JsonResult(new { result = "error", message ="No avatar has been selected." });
            ...
            try
            {
                ...
                return new JsonResult(new { result = "success", avatarurl = avatarUrl });
            }
            catch (Exception exc)
            {
                return new JsonResult(new { result = "error", message = exc.Message });
            }
        }
