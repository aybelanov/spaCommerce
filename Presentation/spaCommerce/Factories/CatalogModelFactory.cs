...
namespace spaCommerce.Factories
{
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual void PrepareSortingOptions(CatalogPagingFilteringModel pagingFilteringModel, CatalogPagingFilteringModel command)
        {
            ...
            // CHANGED
            pagingFilteringModel.AvailableSortOptions.Clear();
            foreach (var option in orderedActiveSortingOptions)
            {
                pagingFilteringModel.AvailableSortOptions.Add(new SelectListItem
                {
                    ...
                    Value = option.Id.ToString(),//_webHelper.ModifyQueryString(currentPageUrl, "orderby", option.Id.ToString()),
            ...
            bool allowCustomersToSelectPageSize, string pageSizeOptions, int fixedPageSize)
        {
            ...
            if (allowCustomersToSelectPageSize && pageSizeOptions != null)
            {
                ...
                if (pageSizes.Any())
                {
                    ...
                    // CHANGED
                    pagingFilteringModel.PageSizeOptions.Clear();
                    foreach (var pageSize in pageSizes)
                    {
                        ...
                        {
                            Text = pageSize,
                            Value = pageSize, //_webHelper.ModifyQueryString(sortUrl, "pagesize", pageSize),
        ...
        #region Categories
        /// <summary>
        /// ADDED for breadcrumbs section, otherwise we need to process all PrepareCategoryModel
        /// </summary>
        /// <param name="category"></param>
        /// <param name="model"></param>
        /// <returns></returns>
        public virtual CategoryModel PrepareCategoryModelBreadCrumb(Category category)
        { //category breadcrumb
            if (_catalogSettings.CategoryBreadcrumbEnabled)
            {
                ...
                return model.CategoryBreadcrumb.Count > 0 ? model : null;
            }
        ...
        public virtual CategoryModel PrepareCategoryModel(Category category, CatalogPagingFilteringModel command)
        {
            ...
            IList<int> alreadyFilteredSpecOptionIds = _uriHelper.GetQueryParameterValues<int>("specs")?.ToList() ?? new List<int>();
            ...
            //specs
            // CHANGED add uriHelper to method's params
            model.PagingFilteringContext.SpecificationFilter.PrepareSpecsFilters(alreadyFilteredSpecOptionIds,
                filterableSpecificationAttributeOptionIds?.ToArray(),
                _specificationAttributeService, _localizationService, _webHelper, _workContext, _cacheManager, _uriHelper);
        ...
        public virtual SearchModel PrepareSearchModel(SearchModel model, CatalogPagingFilteringModel command)
        {
            ...
            // ADDED for analyze of the querystring in Blazor app
            var isSearchTermSpecified = _uriHelper.ContainsKey("q") || _uriHelper.ContainsKey("q");
