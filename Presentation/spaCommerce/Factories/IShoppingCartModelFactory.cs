...
namespace spaCommerce.Factories
{
    ...
    public partial interface IShoppingCartModelFactory
    {
        ...
        WishlistModel.ShoppingCartItemModel PrepareWishlistItemModel(IList<ShoppingCartItem> cart, ShoppingCartItem sci);

        // added
        /// <summary>
        /// Adjusts the Model according selected attributes
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        //ShoppingCartModel AdjustShoppingCartModel(ShoppingCartModel model);
        ShoppingCartModel.ShoppingCartItemModel UpdateQuantityShoppingCartItem(IList<ShoppingCartItem> cart, ShoppingCartModel.ShoppingCartItemModel item);
    }
}
