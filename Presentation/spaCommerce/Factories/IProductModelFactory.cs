...
namespace spaCommerce.Factories
{
    ...
    public partial interface IProductModelFactory
    {
        ...
        // ADDED for product breadcrumb
        /// <summary>
        /// 
        /// </summary>
        /// <param name="product"></param>
        /// <returns></returns>
        ProductDetailsModel.ProductBreadcrumbModel PrepareProductBreadcrumbModel(Product product);

        // ADDED for product price
        /// <summary>
        /// 
        /// </summary>
        /// <param name="product"></param>
        /// <returns></returns>
        ProductDetailsModel.ProductPriceModel PrepareProductPriceModel(Product product);

        //ProductAttributeList InitAttributeList(ProductAttributeList attributeList);
        ProductDetailsModel AdjustProductDetailsModel(ProductDetailsModel model);
        ProductAttributeList PrepareProductAttributeModels(Product product, ShoppingCartItem updatecartitem = null, IDictionary<string, string> form = null);
    }
}
