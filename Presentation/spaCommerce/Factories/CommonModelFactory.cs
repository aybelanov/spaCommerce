    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual SitemapModel PrepareSitemapModel(SitemapPageModel pageModel)
        {
            ...
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
                ...
                var urlHelper = EngineContext.Current.Resolve<LinkGenerator>();
                ...
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.GetPathByRouteValues("HomePage", null)
                });
                ...
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.GetPathByRouteValues("ProductSearch", null)
                });
                ...
                if (_newsSettings.Enabled)
                {
                    model.Items.Add(new SitemapModel.SitemapItemModel
                    {
                        ...
                        Url = urlHelper.GetPathByRouteValues("NewsArchive", null)
                    });
                }
                ...
                if (_blogSettings.Enabled)
                {
                    model.Items.Add(new SitemapModel.SitemapItemModel
                    {
                        ...
                        Url = urlHelper.GetPathByRouteValues("Blog", null)
                    });
                }
                ...
                if (_forumSettings.ForumsEnabled)
                {
                    model.Items.Add(new SitemapModel.SitemapItemModel
                    {
                        ...
                        Url = urlHelper.GetPathByRouteValues("Boards", null)
                    });
                }
                ...
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.GetPathByRouteValues("ContactUs", null)
                });
                ...
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.GetPathByRouteValues("CustomerInfo", null)
                });
                ...
                model.Items.AddRange(topics.Select(topic => new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.GetPathByRouteValues("Topic", new { SeName = _urlRecordService.GetSeName(topic) })
                }));
                ...
                if (_commonSettings.SitemapIncludeCategories)
                {
                    ...
                    model.Items.AddRange(categories.Select(category => new SitemapModel.SitemapItemModel
                    {
                        ...
                        Url = urlHelper.GetPathByRouteValues("Category", new { SeName = _urlRecordService.GetSeName(category) })
                    }));
                }
                ...
                if (_commonSettings.SitemapIncludeManufacturers)
                {
                    ...
                    model.Items.AddRange(manufacturers.Select(manufacturer => new SitemapModel.SitemapItemModel
                    {
                        ...
                        Url = urlHelper.GetPathByRouteValues("Manufacturer", new { SeName = _urlRecordService.GetSeName(manufacturer) })
                    }));
                }
                ...
                if (_commonSettings.SitemapIncludeProducts)
                {
                    ...
                    model.Items.AddRange(products.Select(product => new SitemapModel.SitemapItemModel
                    {
                        ...
                        Url = urlHelper.GetPathByRouteValues("Product", new { SeName = _urlRecordService.GetSeName(product) })
                    }));
                }
                ...
                if (_commonSettings.SitemapIncludeProductTags)
                {
                    ...
                    model.Items.AddRange(productTags.Select(productTag => new SitemapModel.SitemapItemModel
                    {
                        ...
                        Url = urlHelper.GetPathByRouteValues("ProductsByTag", new { SeName = _urlRecordService.GetSeName(productTag) })
                    }));
                }
