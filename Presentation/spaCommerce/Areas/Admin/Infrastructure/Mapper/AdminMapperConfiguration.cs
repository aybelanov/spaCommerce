...
using spaCommerce.Areas.Admin.Models.Affiliates;
using spaCommerce.Areas.Admin.Models.Blogs;
...
using spaCommerce.Areas.Admin.Models.ExternalAuthentication;
using spaCommerce.Areas.Admin.Models.Forums;
using spaCommerce.Areas.Admin.Models.Localization;
using spaCommerce.Areas.Admin.Models.Logging;
using spaCommerce.Areas.Admin.Models.Messages;
using spaCommerce.Areas.Admin.Models.News;
using spaCommerce.Areas.Admin.Models.Orders;
using spaCommerce.Areas.Admin.Models.Payments;
using spaCommerce.Areas.Admin.Models.Plugins;
using spaCommerce.Areas.Admin.Models.Polls;
using spaCommerce.Areas.Admin.Models.Settings;
...
using spaCommerce.Areas.Admin.Models.Tax;
using spaCommerce.Areas.Admin.Models.Templates;
using spaCommerce.Areas.Admin.Models.Topics;
using spaCommerce.Areas.Admin.Models.Vendors;
using Nop.Web.Framework.Models;

namespace spaCommerce.Areas.Admin.Infrastructure.Mapper
{
    /// <summary>
