...
namespace Nop.Web.Framework.Server.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<OfficialFeedManager>().As<IOfficialFeedManager>().InstancePerDependency();//.InstancePerLifetimeScope();
            ...
            else
            {
                ...
                //builder.RegisterType<NopNullCache>()
                    .As<ILocker>()
            ...
            #region added
            //TODO added
            builder.RegisterType<EndpointPublisher>().As<IEndpointPublisher>().InstancePerLifetimeScope();
            builder.RegisterType<JSService>().As<IJSService>().InstancePerLifetimeScope();
            builder.RegisterType<CompareProductsComponentService>().As<ICompareProductsComponentService>().InstancePerLifetimeScope();
            builder.RegisterType<RecentlyViewedProductsComponentService>().As<IRecentlyViewedProductsComponentService>().InstancePerLifetimeScope();
            builder.RegisterType<ComponentAuthStateProvider>().As<AuthenticationStateProvider>().InstancePerLifetimeScope();
            #endregion
