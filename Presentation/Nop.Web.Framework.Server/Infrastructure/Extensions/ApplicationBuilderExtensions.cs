...
using Nop.Web.Framework.Components.Services.Authentication;
using Nop.Web.Framework.Globalization;
using Nop.Web.Framework.Mvc.Routing;
using Nop.Web.Framework.Server.Mvc.Routing;

namespace Nop.Web.Framework.Server.Infrastructure.Extensions
{
    // CHANGED
    /// <summary>
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void UseNopExceptionHandler(this IApplicationBuilder application)
        {
            ...
            if (useDetailedExceptionPage)
            {
                ...
                application.UseBlazorDebugging();
            }
            else
            {
        ...
        /// <summary>
        /// Configure middleware for a requesting culture
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseNopCulture(this IApplicationBuilder application)
        { 
            //check whether database is installed
            if (!DataSettingsManager.DatabaseIsInstalled)
                return;
        ...
        public static void UseNopStaticFiles(this IApplicationBuilder application)
        {
            ...
            // WORKAROUND for blazer server-side. Otherwise the app dooesn't work as a SPA one ( just as a regular MVC one).
        ...
        // TODO added
        /// <summary>
        /// Enable using endpoint routing
        /// </summary>
        /// <param name="app">Builder for configuring an application's request pipeline</param>
        public static void UseNopRouting(this IApplicationBuilder app)
        {
            app.UseRouting();
            app.UsePageNotFound();
        }
        ...
        /// </summary>
        /// <param name="app">Builder for configuring an application's request pipeline</param>
        public static void UseNopEndpoints(this IApplicationBuilder app)
        {
            ...
            {
                EngineContext.Current.Resolve<IEndpointPublisher>().RegisterRoutes(endpointBuilder);
                endpointBuilder.MapControllers();
                endpointBuilder.MapBlazorHub();
                endpointBuilder.MapFallbackToController("Index", "Home");
                //endpointBuilder.MapFallbackToPage("/_Host");
            });
        }
    }
}