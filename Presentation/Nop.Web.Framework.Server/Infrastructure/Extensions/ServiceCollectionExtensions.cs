...
namespace Nop.Web.Framework.Server.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceProvider ConfigureApplicationServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddNopHttpContextAccessor();
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddNopHttpContextAccessor(this IServiceCollection services)
        {
        ...
        public static void AddAntiForgery(this IServiceCollection services)
        {
            ...
            services.AddAntiforgery(options =>
            {
                ...
                //TODO whether to allow the use of anti-forgery cookies from SSL protected page on the other store pages which are not
        ...
        public static IMvcBuilder AddNopMvc(this IServiceCollection services)
        {
            ...
            else
            {
                ...
                mvcBuilder.AddCookieTempDataProvider(options =>
                {
                    ...
                    //TODO whether to allow the use of cookies from SSL protected page on the other store pages which are not
                    //options.Cookie.SecurePolicy = DataSettingsManager.DatabaseIsInstalled && EngineContext.Current.Resolve<SecuritySettings>().ForceSslForAllPages
                    //    ? CookieSecurePolicy.SameAsRequest : CookieSecurePolicy.None;
                });
            }
