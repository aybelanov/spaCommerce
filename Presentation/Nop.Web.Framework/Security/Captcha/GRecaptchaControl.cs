...
namespace Nop.Web.Framework.Security.Captcha
{
    ...
    {
        private const string RECAPTCHA_API_URL = "https://www.google.com/recaptcha/api.js?onload=gcOnloadCallback&render=explicit";
        ...
        public string RenderControl()
        {
            ...
            scriptCallbackTag.InnerHtml.AppendHtml(
                $"var gcOnloadCallback = function() {{grecaptcha.render('{Id}', {{'sitekey' : '{PublicKey}', 'theme' : '{Theme}' }});}};");
            ...
            ScriptSource = RECAPTCHA_API_URL + (string.IsNullOrEmpty(Language) ? "" : $"&hl={Language}");
