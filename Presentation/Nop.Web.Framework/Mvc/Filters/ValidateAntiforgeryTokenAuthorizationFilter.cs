...
{
    internal class ValidateAntiforgeryTokenAuthorizationFilter : IAsyncAuthorizationFilter, Microsoft.AspNetCore.Mvc.ViewFeatures.IAntiforgeryPolicy
    {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            if (!context.IsEffectivePolicy<Microsoft.AspNetCore.Mvc.ViewFeatures.IAntiforgeryPolicy>(this))
            {
                _logger.NotMostEffectiveFilter(typeof(Microsoft.AspNetCore.Mvc.ViewFeatures.IAntiforgeryPolicy));
                return;
            }
            ...
            if (ShouldValidate(context))
            {
                ...
                catch (AntiforgeryValidationException exception)
                {
                    ...
                    context.Result = new Microsoft.AspNetCore.Mvc.AntiforgeryValidationFailedResult();
                }
            }
        }
...
#nullable enable
        public static IDisposable? ViewComponentScope(this ILogger logger, Microsoft.AspNetCore.Mvc.ViewComponents.ViewComponentContext context)
        {
...
#nullable restore
        ...
        public static void ViewComponentExecuting(
            this ILogger logger,
            Microsoft.AspNetCore.Mvc.ViewComponents.ViewComponentContext context,
            object[] arguments)
        {
