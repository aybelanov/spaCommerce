...
namespace Nop.Web.Framework.UI
{
    ...
    public partial class PageHeadBuilder : IPageHeadBuilder
    {
        ...
        // CHANGED the system of distribution of content files (css, js) between Server and Client projects is implemented.
        ///// <summary>
        ///// Generate all script parts
        ///// </summary>
        ///// <param name="urlHelper">URL Helper</param>
        ...
        //        if (partsToBundle.Any())
        //        {
        //            // the folder containing application projects
        //            var appFolderPath = Directory.GetParent(_hostingEnvironment.ContentRootPath).FullName;
        //            var appName = Path.GetFileName(_hostingEnvironment.ContentRootPath).Replace(".Server", string.Empty);
        ...
        //            foreach (var item in partsToBundle)
        //            {
        //                var src = urlHelper.Content(debugModel ? item.DebugSrc : item.Src).TrimStart('/');
        //                var relativeSrcPath = src.Replace("/", "\\");

        //                // if the project isn't a Blazor one 
        //                if (_fileProvider.FileExists($"{appFolderPath}\\{appName}\\{relativeSrcPath}"))
        //                {
        //                    src = appName + "/" + src;
        //                }
        //                else if (_fileProvider.FileExists($"{appFolderPath}\\{appName}\\wwwroot\\{relativeSrcPath}"))
        //                {
        //                    src = $"{appName}/wwwroot/" + src;
        //                }
        //                // checking for existence of  minification files on server app folder
        //                else if (_fileProvider.FileExists($"{appFolderPath}\\{appName}.Server\\{relativeSrcPath}"))
        //                {
        //                    src = $"{appName}.Server/" + src;
        //                }
        //                // checking for existence of  minification files on server app wwwwroot folder
        //                else if (_fileProvider.FileExists($"{appFolderPath}\\{appName}.Server\\wwwroot\\{relativeSrcPath}"))
        //                {
        //                    src = $"{appName}.Server/wwwroot/" + src;
        //                }
        //                // checking for existence of  minification files on client app folder
        //                else if (_fileProvider.FileExists($"{appFolderPath}\\{appName}.Client\\{relativeSrcPath}"))
        //                {
        //                    src = $"{appName}.Client/" + src;
        //                }
        //                // checking for existence of  minification files on client app wwwwroot folder
        //                else if (_fileProvider.FileExists($"{appFolderPath}\\{appName}.Client\\wwwroot\\{relativeSrcPath}"))
        //                {
        //                    src = $"{appName}.Client/wwwroot/" + src;
        //                }
        ...
        //            // important! here's the chunk of the relation path of output minifiction files, wich defines an output folder
        //            // by substracting from the absolute path from configFilePath
        //            // checking is it the Blazor project
        //            appName = _hostingEnvironment.ContentRootPath.Contains(".Server") ? $"{appName}.Client" : appName;
        //            bundle.OutputFileName = $"{appName}/wwwroot/bundles/{outputFileName}.js";

        //            //save
        //            var configFilePath = appFolderPath + "\\" + outputFileName + ".json";
        //            //var configFilePath = _hostingEnvironment.ContentRootPath + "\\" + outputFileName + ".json";
        //            bundle.FileName = configFilePath;
        //            var t2 = bundle.GetAbsoluteInputFiles();
        //            lock (s_lock)
        //            {
        //                //performance optimization. do not bundle and minify for each HTTP request
        //                //we periodically re-check already bundles file
        ...
        //// CHANGED here is implemented the system of distribution of content files (css, js) between Server and Client projects.
        ///// <summary>
        ///// Generate all CSS parts
        ///// </summary>
        ///// <param name="urlHelper">URL Helper</param>
        ...
        //                //var t1 = $"{appFolderPath}\\{appName}.Client\\{relativeSrcPath}";
        ...
        //            // checking is it the Blazor project
        //            appName = _hostingEnvironment.ContentRootPath.Contains(".Server") ? $"{appName}.Client" : appName;
        //            bundle.OutputFileName = $"{appName}/wwwroot/bundles/{outputFileName}.css";
